...
class Client:
    ...
    def handle_implementation_result(
    ...
    def handle_type_definition_result(
        self, context: dict, result: Union[Definition, List[DefinitionLink], None]
    ) -> None:
        """"""

    def handle_workspace_folders_request(
        self, context: dict, params: None
    ) -> Union[List[WorkspaceFolder], None]:
        """"""

    def handle_configuration_request(
        self, context: dict, params: ConfigurationParams
    ) -> List[LSPAny]:
        """"""
    ...
    def handle_document_color_result(
        self, context: dict, result: List[ColorInformation]
    ) -> None:
        """"""
    ...
    def handle_color_presentation_result(
        self, context: dict, result: List[ColorPresentation]
    ) -> None:
        """"""
    ...
    def handle_folding_range_result(
        self, context: dict, result: Union[List[FoldingRange], None]
    ) -> None:
        """"""
    ...
    def handle_declaration_result(
        self, context: dict, result: Union[Declaration, List[DeclarationLink], None]
    ) -> None:
        """"""
    ...
    def handle_selection_range_result(
        self, context: dict, result: Union[List[SelectionRange], None]
    ) -> None:
        """"""

    def handle_work_done_progress_create_request(
        self, context: dict, params: WorkDoneProgressCreateParams
    ) -> None:
        """"""

    def call_hierarchy_prepare_request(
    ...
    def handle_call_hierarchy_prepare_result(
        self, context: dict, result: Union[List[CallHierarchyItem], None]
    ) -> None:
        """"""

    def call_hierarchy_incoming_calls_request(
    ...
    def handle_call_hierarchy_incoming_calls_result(
        self, context: dict, result: Union[List[CallHierarchyIncomingCall], None]
    ) -> None:
        """"""

    def call_hierarchy_outgoing_calls_request(
    ...
    def handle_call_hierarchy_outgoing_calls_result(
        self, context: dict, result: Union[List[CallHierarchyOutgoingCall], None]
    ) -> None:
        """"""
    ...
    def handle_semantic_tokens_result(
        self, context: dict, result: Union[SemanticTokens, None]
    ) -> None:
        """"""
    ...
    def handle_semantic_tokens_delta_result(
        self, context: dict, result: Union[SemanticTokens, SemanticTokensDelta, None]
    ) -> None:
        """"""
    ...
    def handle_semantic_tokens_range_result(
        self, context: dict, result: Union[SemanticTokens, None]
    ) -> None:
        """"""

    def handle_semantic_tokens_refresh_request(
        self, context: dict, params: None
    ) -> None:
        """"""

    def handle_show_document_request(
        self, context: dict, params: ShowDocumentParams
    ) -> ShowDocumentResult:
        """"""
    ...
    def handle_linked_editing_range_result(
        self, context: dict, result: Union[LinkedEditingRanges, None]
    ) -> None:
        """"""
    ...
    def handle_will_create_files_result(
    ...
    def handle_will_rename_files_result(
        self, context: dict, result: Union[WorkspaceEdit, None]
    ) -> None:
        """"""
    ...
    def handle_will_delete_files_result(
        self, context: dict, result: Union[WorkspaceEdit, None]
    ) -> None:
        """"""
    ...
    def handle_moniker_result(
        self, context: dict, result: Union[List[Moniker], None]
    ) -> None:
        """"""

    def type_hierarchy_prepare_request(
    ...
    def handle_type_hierarchy_prepare_result(
        self, context: dict, result: Union[List[TypeHierarchyItem], None]
    ) -> None:
        """"""

    def type_hierarchy_supertypes_request(
    ...
    def handle_type_hierarchy_supertypes_result(
        self, context: dict, result: Union[List[TypeHierarchyItem], None]
    ) -> None:
        """"""

    def type_hierarchy_subtypes_request(
    ...
    def handle_type_hierarchy_subtypes_result(
        self, context: dict, result: Union[List[TypeHierarchyItem], None]
    ) -> None:
        """"""
    ...
    def handle_inline_value_result(
        self, context: dict, result: Union[List[InlineValue], None]
    ) -> None:
        """"""
    ...
    def handle_inlay_hint_result(
        self, context: dict, result: Union[List[InlayHint], None]
    ) -> None:
        """"""
    ...
    def handle_inlay_hint_resolve_result(
        self, context: dict, result: InlayHint
    ) -> None:
        """"""
    ...
    def handle_document_diagnostic_result(
        self, context: dict, result: DocumentDiagnosticReport
    ) -> None:
        """"""
    ...
    def handle_workspace_diagnostic_result(
        self, context: dict, result: WorkspaceDiagnosticReport
    ) -> None:
        """"""
    ...
    def handle_inline_completion_result(
        self,
        context: dict,
    ...
    def handle_text_document_content_result(
        self, context: dict, result: TextDocumentContentResult
    ) -> None:
        """"""

    def handle_text_document_content_refresh_request(
        self, context: dict, params: TextDocumentContentRefreshParams
    ) -> None:
        """"""

    def handle_registration_request(
        self, context: dict, params: RegistrationParams
    ) -> None:
        """"""

    def handle_unregistration_request(
        self, context: dict, params: UnregistrationParams
    ) -> None:
        """"""
    ...
    def handle_show_message_request(
        self, context: dict, params: ShowMessageRequestParams
    ) -> Union[MessageActionItem, None]:
        """"""

    def will_save_text_document_wait_until_request(
    ...
    def handle_will_save_text_document_wait_until_result(
    ...
    def handle_completion_resolve_result(
        self, context: dict, result: CompletionItem
    ) -> None:
        """"""
    ...
    def handle_references_result(
        self, context: dict, result: Union[List[Location], None]
    ) -> None:
        """"""
    ...
    def handle_document_highlight_result(
        self, context: dict, result: Union[List[DocumentHighlight], None]
    ) -> None:
        """"""
    ...
    def handle_workspace_symbol_result(
        self,
        context: dict,
    ...
    def handle_workspace_symbol_resolve_result(
        self, context: dict, result: WorkspaceSymbol
    ) -> None:
        """"""
    ...
    def handle_code_lens_result(
        self, context: dict, result: Union[List[CodeLens], None]
    ) -> None:
        """"""
    ...
    def handle_document_link_result(
        self, context: dict, result: Union[List[DocumentLink], None]
    ) -> None:
        """"""
    ...
    def handle_document_link_resolve_result(
        self, context: dict, result: DocumentLink
    ) -> None:
        """"""
    ...
    def document_range_formatting_request(
        self, params: DocumentRangeFormattingParams
    ) -> None:
        """A request to format a range in a document."""
        self.request(method="textDocument/rangeFormatting", params=params)

    def handle_document_range_formatting_result(
        self, context: dict, result: Union[List[TextEdit], None]
    ) -> None:
        """"""

    def document_ranges_formatting_request(
        self, params: DocumentRangesFormattingParams
    ) -> None:
    ...
    def handle_document_ranges_formatting_result(
        self, context: dict, result: Union[List[TextEdit], None]
    ) -> None:
        """"""

    def document_on_type_formatting_request(
        self, params: DocumentOnTypeFormattingParams
    ) -> None:
        """A request to format a document on type."""
        self.request(method="textDocument/onTypeFormatting", params=params)

    def handle_document_on_type_formatting_result(
        self, context: dict, result: Union[List[TextEdit], None]
    ) -> None:
        """"""
    ...
    def did_change_workspace_folders_notification(
    ...
    def work_done_progress_cancel_notification(
    ...
    def did_open_notebook_document_notification(
    ...
    def did_change_notebook_document_notification(
        self, params: DidChangeNotebookDocumentParams
    ) -> None:
        self.notify(method="notebookDocument/didChange", params=params)

    def did_save_notebook_document_notification(
        self, params: DidSaveNotebookDocumentParams
    ) -> None:
    ...
    def did_close_notebook_document_notification(
    ...
    def did_change_configuration_notification(
    ...
    def handle_telemetry_event_notification(
        self, context: dict, params: LSPAny
    ) -> None:
        """"""

    def did_open_text_document_notification(
    ...
    def did_change_text_document_notification(
    ...
    def did_close_text_document_notification(
    ...
    def did_save_text_document_notification(
    ...
    def will_save_text_document_notification(
        self, params: WillSaveTextDocumentParams
    ) -> None:
    ...
    def did_change_watched_files_notification(
    ...
    def handle_log_trace_notification(
        self, context: dict, params: LogTraceParams
    ) -> None:
        """"""
    ...
    def handle_progress_notification(
        self, context: dict, params: ProgressParams
    ) -> None:
        """"""
